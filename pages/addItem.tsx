  ...
  return(
    <div>
      ...
      <main className="max-w-6xl mx-auto p-10 border" >
        ...
        <p className="pb-5" >
          By adding an item to the markeplace, you're essentially Minting an NFT of the item into your wallet which we can then list for sale!
        </p>
        <div className="flex flex-col justify-center items-center md:flex-row md:space-x-5 pt-5 " >
          ...
          <form onSubmit={mintNFT} className="flex flex-col flex-1 p-2 space-y-2" >
            ...
            <input className="pb-4" type="file" onChange={e => {
              if(e.target.files?.[0]) {
            ...
            <button type="submit" className="bg-blue-600 font-bold text-white rounded-full py-4 px-10 w-56 mt-5 md:mt-auto mx-auto ml-auto" >Add/Mint Item</button>
          </form>
        </div>
      </main>
    </div>
